# cpfs-preparation-log

Sushmitas sample preparation
...
```sh
git clone https://github.com/MPI CPfS Dresden/cpfs-preparation-log.git
cd cpfs-preparation-log
...
```sh
pip install dist/cpfs-preparation-log-0.1.0
```
